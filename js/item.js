...
class Item {
    ...
    toString(){
        console.log(`Id:${this._id}, Name:${this._name}, Level:${this._level}, Grade:${this._grade}, Attack:${this._attack}, Health:${this._health}, Defense:${this._defense}, Lucky:${this._lucky}, EquipPosition:${this.getEquipPosition()}`)
    }
}
